...
def readModel():
    bert = BertModel.from_pretrained(os.path.join('bertmodel'))
    return bert
def readTokenizer():
    tokenizer = BertTokenizer.from_pretrained(os.path.join('bertmodel'))
    return tokenizer
...
def parse_arguments(parser):
    ...
    parser.add_argument('--algorithm', type=str, choices=["random", "WRA"], help="algorithm")
    parser.add_argument('--template', type=str, choices=["multi-class", "multi-classL", help="template mode")
